        ...
        if x == 's':
            ...
            try:
                if ValidateFile(file_name):
                    ...
                    print(f"{file_name} ha sido cifrado, eliminado y guardado como {file_name}.encrypted")
                    logging.info(f"{file_name} ha sido cifrado, eliminado y guardado como {file_name}.encrypted")
                else:
            ...
            if decrypt_choice == 's':
                ...
                try:
                    if ValidateFile(file_name):
                        ...
                        print(f"{file_name} ha sido descifrado y guardado como {file_name.replace('.encrypted', '')}")
                        logging.info(f"{file_name} ha sido descifrado y guardado como {file_name.replace('.encrypted', '')}")
                    else:
                        print('Por favor, ingrese un archivo que exista.')
                except Exception as e:
                    print(f'Error: {e}')
